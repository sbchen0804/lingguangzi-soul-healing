...
assert.match(css, /\.page-stack\[aria-label\*="原圖文"\] img\{aspect-ratio:850\/1100/, '原圖文圖片應預留正確比例');
assert.match(css, /\.page-stack\[aria-label\*="精煉篇"\] img\{aspect-ratio:1912\/1067/, '精煉篇圖片應預留正確比例');
assert.match(css, /\.page-stack\[aria-label\*="精煉篇"\] figure\{aspect-ratio:auto/, '精煉篇頁框應計入頁碼高度，避免覆蓋下一段內容');
